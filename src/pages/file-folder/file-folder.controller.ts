...
export class FileFolderController {
  ...
  /**
   * Public Api
   * getAllFileFolderByShop()
   */
  @Post('/get-all-by-shop')

  @UsePipes(ValidationPipe)
  async getAllFileFolderByShop(
    @Body() filterFileFolderDto: FilterAndPaginationFileFolderDto,
    @Query('shop', MongoIdValidationPipe) shop: string,
    @Query('q') searchString: string,
  ): Promise<ResponsePayload> {
    return await this.fileFolderService.getAllFileFolderByShop(
      shop,
      filterFileFolderDto,
      searchString,
    );
  ...
  async addFileFolder(
    ...
    return await this.fileFolderService.addFileFolder( shop,addFileFolderDto);
  }
