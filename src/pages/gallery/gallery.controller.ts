...
export class GalleryController {
  ...
  async getAllGalleryByShop(
    @Body() filterGalleryDto: FilterAndPaginationGalleryDto,
    @Query('shop', MongoIdValidationPipe) shop: string,
    @Query('q') searchString: string,
  ): Promise<ResponsePayload> {
    return await this.galleryService.getAllGalleryByShop(
      shop,
      filterGalleryDto,
      searchString,
    );
  ...
  async addGallery(
    ...
    return await this.galleryService.addGallery(shop, addGalleryDto);
  }
  ...
  async insertManyGallery(
    ...
    return await this.galleryService.insertManyGallery(
      shop,
      body.data,
      body.option,
    );
